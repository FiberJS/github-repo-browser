...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _github = __webpack_require__(10);
	...
	_namespace2.default.GitHub.listen(_events2.default.UserQuery.Response, function (event) {
	...
	}, _events2.default.UserQuery.Error, function (event) {
	    console.log(event);
	});

	_namespace2.default.GitHub.trigger(new _events2.default.UserQuery.Request('buzz'));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _dataComponent = __webpack_require__(3);

	var _dataComponent2 = _interopRequireDefault(_dataComponent);

	var _uiComponent = __webpack_require__(5);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var UserQuery = _flight2.default.eventType(function (query) {
	    this.query = query;
	});
	...
	var ItemList = function (_Flight$Event) {
	    _inherits(ItemList, _Flight$Event);
	...
	Events.UserQuery = {};
	Events.UserQuery.Request = _flight2.default.eventOfType(UserQuery).alias('UserQuery:Request');
	Events.UserQuery.Response = _flight2.default.eventOfType(ItemList).alias('UserQuery:Response');
	...
	Events.Repositories.Response = _flight2.default.eventOfType(ItemList).alias('Repositories:Response');
	...
	var UserSearchComponent = function (_Flight$UIComponent) {
	    ...
	    _createClass(UserSearchComponent, [{
	        ...
	        value: function listen() {
	            ...
	            this.ui('#search-query').listen('keypress', function (event) {
